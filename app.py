...
market = st.radio("Market", ["🇺🇸 US Stock", "🇰🇷 KR Stock"], horizontal=True)
...
if st.button("Analyze"):
    with st.spinner("Fetching data..."):
        ...
        fig = make_subplots(
            ...
            subplot_titles=(f"{symbol} Price", "MACD", "RSI", "Williams %R / Stochastic", "OBV")
        )
        ...
        fig.update_layout(height=1000, title=f"{symbol} Full Analysis", xaxis_rangeslider_visible=False)
